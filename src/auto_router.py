...
def auto_route_and_generate(content: str, num_cards: int = 8) -> Dict[str, Any]:
    ...
    system_prompt = (
        ...
        "   - 'ESAMC' (se for sobre sistemas de informação em ADM, ERP, banco de dados, TI, BI, governança).\n"
        "   - 'SENAI' (se for sobre rotinas administrativas, segurança do trabalho, qualidade 5S, desenhos técnicos, logística, finanças, gestão de pessoas, RH ou informatica).\n"
